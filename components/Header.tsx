            ...
            <div className="hidden xl:flex items-center flex-1 max-w-md mx-6">
              <div className="relative w-full">
                ...
                <input
                  ...
                  readOnly
                  className="w-full bg-[#06070B] border border-gray-700 rounded-full pl-10 pr-4 py-2 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer"
                />
              </div>
            </div>
